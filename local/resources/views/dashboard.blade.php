...
<head>
    ...
    <!-- favicon icon -->
    <link rel="icon" href="{{ URL::to('socian.png') }}">
    <!-- All CSS Files Here -->
    <link rel="stylesheet" href="{{ URL::to('bootstrap.min.css') }}">

    <link href="{{ URL::to('summernote.css') }}" rel="stylesheet" />

    <link rel="stylesheet" href="{{ URL::to('et-line-fonts.css') }}">
    <link rel="stylesheet" href="{{ URL::to('global.css') }}">
    <link rel="stylesheet" href="{{ URL::to('style.css') }}">
    <link rel="stylesheet" href="{{ URL::to('responsive.css') }}">
    <link rel="stylesheet" href="{{ URL::to('font-awesome.min.css') }}">
</head>
<body>
<!--[if lt IE 8]>
...
<script src="{{ URL::to('summernote.min.js') }}"></script>

<script>
    jQuery(document).ready(function () {
        var ppp = <?php echo json_encode($wordlist) ?>;
                //JSON.parse('{{ json_encode($wordlist) }}');
